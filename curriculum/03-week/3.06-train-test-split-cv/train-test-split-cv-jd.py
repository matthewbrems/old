...
## The line / model'
# y_test are our tested values, and predictions are what the model thought would be the y for the given Xs
# since it's plotting y values against y values, a perfect model would plot a line y = y
...
# seaborn -- lm_plot 
# grab .coeff and grab those coefficients then create a function and map the function
